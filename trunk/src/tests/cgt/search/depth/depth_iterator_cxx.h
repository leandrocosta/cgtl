...
/*!
 * \file tests/cgt/search/depth/depth_iterator_cxx.h
 * \brief Contains unit tests for class cgt::search::depth::depth_iterator.
...
#ifndef __CGTL__CXXTEST_CGT_SEARCH_DEPTH_DEPTH_ITERATOR_CXX_H_
#define __CGTL__CXXTEST_CGT_SEARCH_DEPTH_DEPTH_ITERATOR_CXX_H_

#include <cxxtest/TestSuite.h>
#include "cgt/graph.h"


class depth_iterator_cxx : public CxxTest::TestSuite
{
  private:
  ...
  public:
    ...
    void test_basic ()
    {
      ...
      mygraph::diterator it    = g.dbegin ();
      mygraph::diterator itEnd = g.dend ();
...
#endif // __CGTL__CXXTEST_CGT_SEARCH_DEPTH_DEPTH_ITERATOR_CXX_H_
