...
/*!
 * \file cgt/shortpath/single/bellford/bellford_info_list.h
 * \brief Containss definition of a list of structures used by Bellford iterator.
 * \author Leandro Costa
 * \date 2009
 *
 * $LastChangedDate: 2011-02-16 14:36:44 -0200 (Qua, 16 Fev 2011) $
...
namespace cgt
{
  namespace shortpath
  {
    namespace single
    {
      ...
      {
        /*!
         * \class _BellfordInfoList
         * \brief A list of bellford info structures used by bellford iterator.
         * \author Leandro Costa
         * \date 2009
         *
         * The list used by Bellford Algorithm to keep the nodes already taken.
         * This is also the list of bellford infos that can be obtained after
         * the algorithm finish.
         */

        template<typename _TpVertex, typename _TpEdge>
#ifdef CGTL_DO_NOT_USE_STL
          class _BellfordInfoList : public cgt::base::list<_BellfordInfo<_TpVertex, _TpEdge> >
#else
          class _BellfordInfoList : public std::list<_BellfordInfo<_TpVertex, _TpEdge> >
#endif
        {
          private:
            typedef _BellfordInfo<_TpVertex, _TpEdge>     _Info;
            typedef _BellfordInfoList<_TpVertex, _TpEdge> _Self;
#ifdef CGTL_DO_NOT_USE_STL
        ...
        template<typename _TpVertex, typename _TpEdge>
		  ...
		  */
		  ...
		  /*
        template<typename _TpVertex, typename _TpEdge>
          typename _BellfordInfoList<_TpVertex, _TpEdge>::_Iterator _BellfordInfoList<_TpVertex, _TpEdge>::get_closest ()
          {
		 ...
		 /*
        template<typename _TpVertex, typename _TpEdge>
          void _BellfordInfoList<_TpVertex, _TpEdge>::relax (const _Node* const _ptr_node, const _TpEdge& _distance, const _Edge& _edge, _Node* const _ptr_prev)
          {
