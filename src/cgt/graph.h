...
template<typename _TpVertex, typename _TpGraphType>
    class graph<_TpVertex, void, _TpGraphType> : private _GraphAdjMatrix<_TpVertex, void, _TpGraphType>
  {
    private:
    ...
    public:
      ...
      /** vertex iterator */
#ifdef CGTL_DO_NOT_USE_STL
      typedef _VertexIterator<_TpVertex, void>                                viterator;
      typedef _VertexIterator<_TpVertex, void, cgt::base::iterator::_TpConst> const_viterator;
#else
      typedef _VertexSTLIterator<_TpVertex, void>    	viterator;
      typedef _VertexSTLConstIterator<_TpVertex, void>	const_viterator;
#endif
      ...
      /** depth-first search iterator */
      typedef cgt::search::depth::_DepthIterator<_TpVertex, void>                                 diterator;
      typedef cgt::search::depth::_DepthIterator<_TpVertex, void, cgt::base::iterator::_TpConst>  const_diterator;
      typedef typename diterator::_DepthInfo                                                         depth_info;
#ifdef CGTL_DO_NOT_USE_STL
      typedef typename cgt::base::list<depth_info>::iterator                                         diiterator;
      typedef typename cgt::base::list<depth_info>::const_iterator                                   const_diiterator;
      ...
      /** breadth-first search iterator */
      typedef cgt::search::breadth::_BreadthIterator<_TpVertex, void>                                 biterator;
      typedef cgt::search::breadth::_BreadthIterator<_TpVertex, void, cgt::base::iterator::_TpConst>  const_biterator;
      typedef typename biterator::_BreadthInfo                                                           breadth_info;
#ifdef CGTL_DO_NOT_USE_STL
      typedef typename cgt::base::list<breadth_info>::iterator                                           biiterator;
      typedef typename cgt::base::list<breadth_info>::const_iterator                                     const_biiterator;
      ...
      /** dijkstra iterator */
/*
      typedef cgt::shortpath::single::dijkstra::_DijkstraIterator<_TpVertex, void>                                 djiterator;
      typedef cgt::shortpath::single::dijkstra::_DijkstraIterator<_TpVertex, void, cgt::base::iterator::_TpConst>  const_djiterator;
      typedef typename djiterator::_Info                                                                              dijkstra_info;
#ifdef CGTL_DO_NOT_USE_STL
      typedef typename cgt::base::list<dijkstra_info>::iterator                                                       djiiterator;
      typedef typename cgt::base::list<dijkstra_info>::const_iterator                                                 const_djiiterator;
...
*/
      ...
      /** strongly connected components iterator */
      typedef cgt::stconncomp::_SCCIterator<_TpVertex, void>                                scciterator;
      typedef cgt::stconncomp::_SCCIterator<_TpVertex, void, cgt::base::iterator::_TpConst> const_scciterator;
      typedef cgt::stconncomp::_GraphSCCComponent<_TpVertex, void>                          scc;
      typedef cgt::stconncomp::_GraphSCCNode<_TpVertex, void>                               sccnode;
      ...
      /** prim iterator */
      typedef cgt::minspantree::prim::_PrimIterator<_TpVertex, void>                                piterator;
      typedef cgt::minspantree::prim::_PrimIterator<_TpVertex, void, cgt::base::iterator::_TpConst> const_piterator;
      ...
      /** kruskal iterator */
      typedef cgt::minspantree::kruskal::_KruskalIterator<_TpVertex, void>                                kiterator;
      typedef cgt::minspantree::kruskal::_KruskalIterator<_TpVertex, void, cgt::base::iterator::_TpConst> const_kiterator;
      ...
      /** topological sort iterator */
      typedef cgt::toposort::_ToposortIterator<_TpVertex, void>                                tsiterator;
      typedef cgt::toposort::_ToposortIterator<_TpVertex, void, cgt::base::iterator::_TpConst> const_tsiterator;
